...
class CustomDagRunOperator(BaseOperator):
    ...
    :param trigger_dag_run_id: the run_id to trigger
    :type trigger_dag_run_id: str
    ...
    """
    template_fields = ['trigger_dag_id','trigger_dag_run_id','execution_date']
    template_ext = tuple()
    ui_color = '#ffefeb'
    ...
    def execute(self, context):
        ...
        if dro:
            ...
            self.log.info("Creating DagRun with id %s", self.trigger_dag_id)
            self.log.info("Creating DagRun with run id %s", self.trigger_dag_run_id)
