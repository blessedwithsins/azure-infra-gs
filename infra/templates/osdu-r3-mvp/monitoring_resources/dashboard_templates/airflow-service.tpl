        ...
        "parts": {
          ...
          "5": {
            ...
            "metadata": {
              ...
              "settings": {
                "content": {
                  "Query": "customMetrics\n| where name has \"ti_failures\"\n| parse kind=regex name with @\"([0-9a-zA-Z_])*\\.\" partitionId @\"\\.ti_failures\" \n| extend dataPartitionId = case(partitionId == \"\", \"sr\",\n                       partitionId)\n| summarize TaskInstanceFailures = max(value) by bin(timestamp, 1m), MetricName=\"TaskInstance Failures\", dataPartitionId\n| render timechart \n\n",
          ...
          "6": {
            ...
            "metadata": {
              ...
              "settings": {
                "content": {
                  "Query": "customMetrics\n| where name has \"dagbag_size\"\n| parse kind=regex name with @\"([0-9a-zA-Z_])*\\.\" partitionId @\"\\.dagbag_size\" \n| extend dataPartitionId = case(partitionId == \"\", \"sr\",\n                       partitionId)\n| summarize DagBagSize = max(value) by bin(timestamp, 1m), MetricName = \"dagbag_size\", dataPartitionId\n| render timechart \n\n",
          ...
          "7": {
            ...
            "metadata": {
              ...
              "settings": {
                "content": {
                  "Query": "customMetrics\n| where name has \"dag_processing.import_errors\"\n| parse kind=regex name with @\"([0-9a-zA-Z_])*\\.\" partitionId @\"\\.dag_processing\\.import_errors\" \n| extend dataPartitionId = case(partitionId == \"\", \"sr\",\n                       partitionId)\n| summarize ImportErrors = max(value) by bin(timestamp, 1m),MetricName = \"Import_Errors\", dataPartitionId\n| render timechart ",
          ...
          "9": {
            ...
            "metadata": {
              ...
              "settings": {
                "content": {
                  "Query": "customMetrics\n| where name has \"dag_processing.processor_timeouts\"\n| parse kind=regex name with @\"([0-9a-zA-Z_])*\\.\" partitionId @\"\\.dag_processing\\.processor_timeouts\" \n| extend dataPartitionId = case(partitionId == \"\", \"sr\",\n                       partitionId)\n| summarize ProcessorTimeouts = max(value) by bin(timestamp, 1m), MetricName = \"dag_processing.processor_timeouts\", dataPartitionId\n| render timechart \n",
          ...
          "10": {
            ...
            "metadata": {
              ...
              "settings": {
                "content": {
                  "Query": "customMetrics\n| where name has \"dag_processing.processes\"\n| parse kind=regex name with @\"([0-9a-zA-Z_])*\\.\" partitionId @\"\\.dag_processing\\.processes\" \n| extend dataPartitionId = case(partitionId == \"\", \"sr\",\n                       partitionId)\n| summarize ConcurrentDagProcesses = max(value) by bin(timestamp, 1m), MetricName=\"dag_processing.processes\", dataPartitionId\n| render timechart \n\n",
          ...
          "12": {
            ...
            "metadata": {
              ...
              "settings": {
                "content": {
                  "Query": "customMetrics\n| where name has \"executor.running_tasks\"\n| parse kind=regex name with @\"([0-9a-zA-Z_])*\\.\" partitionId @\"\\.executor\\.running_tasks\" \n| extend dataPartitionId = case(partitionId == \"\", \"sr\",\n                       partitionId)\n| summarize RunningTasks = max(value) by bin(timestamp, 1m), MetricName=\"executor.running_tasks\", dataPartitionId\n| render timechart \n",
          ...
          "13": {
            ...
            "metadata": {
              ...
              "settings": {
                "content": {
                  "Query": "customMetrics\n| where name has \"executor.open_slots\"\n| parse kind=regex name with @\"([0-9a-zA-Z_])*\\.\" partitionId @\"\\.executor\\.open_slots\" \n| extend dataPartitionId = case(partitionId == \"\", \"sr\",\n                       partitionId)\n| summarize OpenSlots = max(value) by bin(timestamp, 1m), MetricName=\"executor.open_slots\", dataPartitionId\n| render timechart \n\n",
          ...
          "14": {
            ...
            "metadata": {
              ...
              "settings": {
                "content": {
                  "Query": "customMetrics\n| where name has \"executor.queued_tasks\"\n| parse kind=regex name with @\"([0-9a-zA-Z_])*\\.\" partitionId @\"\\.executor\\.queued_tasks\"\n| extend dataPartitionId = case(partitionId == \"\", \"sr\",\n                       partitionId)\n| summarize QueuedTasks = max(value) by bin(timestamp, 1m), MetricName = \"executor.queued_tasks\", dataPartitionId\n| render timechart\n\n",
