...
provider "kubernetes" {
  host                   = var.deploy_dp_airflow == "true" ? module.airflow.0.kube_config_block.0.host : ""
  username               = var.deploy_dp_airflow == "true" ? module.airflow.0.kube_config_block.0.username : ""
  password               = var.deploy_dp_airflow == "true" ? module.airflow.0.kube_config_block.0.password : ""
  client_certificate     = var.deploy_dp_airflow == "true" ? base64decode(module.airflow.0.kube_config_block.0.client_certificate) : ""
  client_key             = var.deploy_dp_airflow == "true" ? base64decode(module.airflow.0.kube_config_block.0.client_key) : ""
  cluster_ca_certificate = var.deploy_dp_airflow == "true" ? base64decode(module.airflow.0.kube_config_block.0.cluster_ca_certificate) : ""
}
...
module "airflow" {
  source = "./airflow"
  count  = var.deploy_dp_airflow == "true" ? 1 : 0
